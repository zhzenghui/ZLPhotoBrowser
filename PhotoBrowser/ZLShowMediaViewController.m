...
@interface ZLShowMediaViewController () <UIScrollViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate>
{
...
@implementation ZLShowMediaViewController
...
- (void)initCollectionView
{
    ...
    [_collectionView registerClass:[ZLVideoCell class] forCellWithReuseIdentifier:@"ZLVideoCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (model.type == ZLAssetMediaTypeVideo) {
        cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"ZLVideoCell" forIndexPath:indexPath];
    }
